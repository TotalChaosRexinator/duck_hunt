...
import duck_hunt.libs.score.ScoreList;
...
public class scoreController implements Controller {
	...
	void openPopWindow(ActionEvent event) {
		...
		try {
			scoreStorageService.saveScoreToFile(new Score(playerName, playerScore));
		} catch (Exception e) {
	...
	public void setMain(Main main) {
		...
		this.quack.setVolume(this.main.getVolume());
		 this.scoreStorageService = new ScoreFileStorage();
	}
	...
	public void updateScoreAndDisplay(int score) {
		...
		try {
			list = scoreStorageService.getScoresFromFile();
		} catch (Exception e) {
